        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-10 lg:gap-12">
          <div className="sm:col-span-2 lg:col-span-2">
            ...
            <div className="flex gap-3 sm:gap-4">
              <a
                ...
                className="w-9 h-9 sm:w-10 sm:h-10 bg-background/10 rounded-full flex items-center justify-center hover:bg-accent transition-colors duration-300"
              >
          ...
          <div>
            ...
            <ul className="space-y-2 sm:space-y-3">
              <li>
                <a href="#inicio" className="text-background/60 hover:text-accent transition-colors text-sm sm:text-base">
                  Inicio
                </a>
              </li>
              <li>
                <a href="#productos" className="text-background/60 hover:text-accent transition-colors text-sm sm:text-base">
                  Productos
                </a>
              </li>
              <li>
                <a href="#servicios" className="text-background/60 hover:text-accent transition-colors text-sm sm:text-base">
                  Servicios
                </a>
              </li>
              <li>
                <a href="#nosotros" className="text-background/60 hover:text-accent transition-colors text-sm sm:text-base">
                  Nosotros
                </a>
              </li>
              <li>
                <a href="#ubicacion" className="text-background/60 hover:text-accent transition-colors text-sm sm:text-base">
                  Ubicación
                </a>
              </li>
              <li>
                <a href="#contacto" className="text-background/60 hover:text-accent transition-colors text-sm sm:text-base">
                  Contacto
                </a>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3 sm:space-y-4">
              <li className="flex items-start gap-2 sm:gap-3">
                ...
                <span className="text-background/60 text-sm sm:text-base">Caracas, Venezuela</span>
              </li>
              <li className="flex items-center gap-2 sm:gap-3">
                <Phone className="text-accent flex-shrink-0 w-4 h-4 sm:w-[18px] sm:h-[18px]" />
                <a href="tel:+584241234567" className="text-background/60 hover:text-accent transition-colors text-sm sm:text-base">
                  +58 424 123 4567
                </a>
              </li>
              <li className="flex items-center gap-2 sm:gap-3">
                <Mail className="text-accent flex-shrink-0 w-4 h-4 sm:w-[18px] sm:h-[18px]" />
                <a href="mailto:info@pintualiado.com" className="text-background/60 hover:text-accent transition-colors text-sm sm:text-base break-all">
