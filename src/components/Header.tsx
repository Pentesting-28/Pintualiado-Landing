          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              ...
              >
                ...
                <span className="hidden lg:inline">Atención en Línea</span>
                <span className="lg:hidden">Chat</span>
              </button>

              <button
                onClick={() => setIsMobileMenuOpen(!isMobileMenuOpen)}
                className="lg:hidden p-2 text-foreground hover:text-accent transition-colors relative z-[1003]"
        ...
        <AnimatePresence>
          {isMobileMenuOpen && (
            <motion.div
              ...
              className="fixed inset-0 bg-background z-[999] lg:hidden flex flex-col pt-24 px-6 overflow-y-auto"
            >
              <nav className="flex flex-col space-y-6">
                ...
                <button
                  ...
                  className="flex items-center gap-2 bg-[#25D366] text-white px-5 py-3 rounded-full text-lg font-bold shadow-lg mt-4 w-full justify-center"
                >
